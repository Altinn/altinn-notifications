...
namespace Altinn.Notifications.Tests.Notifications.Core.TestingServices
{
    public class EmailNotificationSummaryServiceTests
    {
        ...
        [InlineData(EmailNotificationResultType.Failed_RecipientReserved, "The email was not sent because the recipient has reserved themselves from electronic communication.")]
