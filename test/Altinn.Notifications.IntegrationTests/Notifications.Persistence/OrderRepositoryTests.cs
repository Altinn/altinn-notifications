...
namespace Altinn.Notifications.IntegrationTests.Notifications.Persistence
{
    public class OrderRepositoryTests : IAsyncLifetime
    {
        ...
        [Theory]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.New, EmailNotificationResultType.New, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.New, EmailNotificationResultType.Failed, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed, EmailNotificationResultType.New, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Sending, EmailNotificationResultType.New, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.New, EmailNotificationResultType.Sending, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Accepted, EmailNotificationResultType.New, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Delivered, EmailNotificationResultType.New, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.New, EmailNotificationResultType.Delivered, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.New, EmailNotificationResultType.Succeeded, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_Deleted, EmailNotificationResultType.New, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_Expired, EmailNotificationResultType.New, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.New, EmailNotificationResultType.Failed_Bounced, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_Rejected, EmailNotificationResultType.New, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_Undelivered, EmailNotificationResultType.New, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.New, EmailNotificationResultType.Failed_Quarantined, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.New, EmailNotificationResultType.Failed_FilteredSpam, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_BarredReceiver, EmailNotificationResultType.New, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.New, EmailNotificationResultType.Failed_TransientError, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_InvalidRecipient, EmailNotificationResultType.New, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_RecipientReserved, EmailNotificationResultType.New, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.New, EmailNotificationResultType.Failed_RecipientReserved, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.New, EmailNotificationResultType.Failed_InvalidEmailFormat, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.New, EmailNotificationResultType.Failed_SupressedRecipient, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_Deleted, EmailNotificationResultType.Failed_Bounced, OrderProcessingStatus.Completed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_RecipientNotIdentified, EmailNotificationResultType.New, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.New, EmailNotificationResultType.Failed_RecipientNotIdentified, OrderProcessingStatus.Processed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_Expired, EmailNotificationResultType.Failed_FilteredSpam, OrderProcessingStatus.Completed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_Rejected, EmailNotificationResultType.Failed_Quarantined, OrderProcessingStatus.Completed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_RecipientNotIdentified, EmailNotificationResultType.Delivered, OrderProcessingStatus.Completed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_Undelivered, EmailNotificationResultType.Failed_RecipientReserved, OrderProcessingStatus.Completed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_BarredReceiver, EmailNotificationResultType.Failed_InvalidEmailFormat, OrderProcessingStatus.Completed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_InvalidRecipient, EmailNotificationResultType.Failed_SupressedRecipient, OrderProcessingStatus.Completed)]
        [InlineData(OrderProcessingStatus.Processing, SmsNotificationResultType.Failed_RecipientReserved, EmailNotificationResultType.Failed_RecipientNotIdentified, OrderProcessingStatus.Completed)]
        public async Task TryMarkOrderAsCompleted_WithDifferentAlternateIdentifierSources_CallsDatabaseWithCorrectSource(
            OrderProcessingStatus orderStatus,
            SmsNotificationResultType smsStatus,
            EmailNotificationResultType emailStatus,
            OrderProcessingStatus expectedOrderStatus)
        {
            // Arrange
            var orderRepository = (OrderRepository)ServiceUtil.GetServices([typeof(IOrderRepository)]).First(i => i.GetType() == typeof(OrderRepository));
            var smsNotificationRepository = (SmsNotificationRepository)ServiceUtil.GetServices([typeof(ISmsNotificationRepository)]).First(i => i.GetType() == typeof(SmsNotificationRepository));
            var emailNotificationRepository = (EmailNotificationRepository)ServiceUtil.GetServices([typeof(IEmailNotificationRepository)]).First(i => i.GetType() == typeof(EmailNotificationRepository));

            NotificationOrder orderNotification = new()
            {
                ResourceId = null,
                Id = Guid.NewGuid(),
                Creator = new("ttd"),
                ...
                Type = OrderType.Notification,
                SendersReference = "order-repository-test",
                SendingTimePolicy = SendingTimePolicy.Anytime,
                NotificationChannel = NotificationChannel.Email,
                Created = new DateTime(2025, 06, 16, 08, 45, 00, DateTimeKind.Utc),
                RequestedSendTime = new DateTime(2025, 06, 16, 08, 50, 00, DateTimeKind.Utc),
            ...
            SmsNotification smsNotification = new()
            {
                ...
                SendResult = new(smsStatus, DateTime.UtcNow),
                RequestedSendTime = new DateTime(2025, 06, 16, 08, 50, 00, DateTimeKind.Utc),
                Recipient = new()
                {
            ...
            EmailNotification emailNotification = new()
            {
                Id = Guid.NewGuid(),
                OrderId = orderNotification.Id,
                SendResult = new(emailStatus, DateTime.UtcNow),
                RequestedSendTime = new DateTime(2025, 06, 16, 08, 50, 00, DateTimeKind.Utc),
                Recipient = new()
                {
            ...
            _orderIdsToDelete.Add(orderNotification.Id);

            await orderRepository.Create(orderNotification);

            await orderRepository.SetProcessingStatus(orderNotification.Id, orderStatus);

            await smsNotificationRepository.AddNotification(smsNotification, DateTime.UtcNow.AddDays(1), 1);
            await smsNotificationRepository.UpdateSendStatus(smsNotification.Id, smsStatus);

            await emailNotificationRepository.AddNotification(emailNotification, DateTime.UtcNow.AddDays(1));
            await emailNotificationRepository.UpdateSendStatus(emailNotification.Id, emailStatus);

            // Act
            await orderRepository.TryMarkOrderAsCompleted(orderNotification.Id, AlternateIdentifierSource.Order);

            // Assert
            string orderWithSpecificStatusSql = $@"SELECT count(1) FROM notifications.orders WHERE alternateid = '{orderNotification.Id}' and processedstatus = '{expectedOrderStatus}'";

            int orderWithSpecificStatusCount = await PostgreUtil.RunSqlReturnOutput<int>(orderWithSpecificStatusSql);
            Assert.Equal(1, orderWithSpecificStatusCount);
        }
    }
}
