...
/// (represented by <see cref="IDeliveryStatusInfo"/> implementations) while maintaining its own status information.
...
public interface IShipmentDeliveryManifestExt : IStatusExt
{
    ...
    /// </summary>
    /// <value>
    /// An immutable list of <see cref="IDeliveryStatusInfo"/> instances, each representing
    /// a delivery manifest to a specific recipient through a particular communication channel.
    /// </value>
    [JsonPropertyName("recipients")]
    IImmutableList<IDeliveryStatusInfo> Recipients { get; }
}
