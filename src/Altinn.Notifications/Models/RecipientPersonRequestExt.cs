...
/// <summary>
/// Represents a request containing all the information needed to deliver either an email or SMS to a specific person identified by their national identity number.
/// </summary>
public class RecipientPersonRequestExt
{
    ...
    /// <summary>
    /// Gets or sets an optional resource identifier linked to this notification,
    /// used for validating eligibility or relevant context in external systems.
    /// </summary>
    [JsonPropertyOrder(2)]
