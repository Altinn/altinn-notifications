...
public static class ShipmentDeliveryManifestMapper
{
    ...
    /// <returns>
    /// An appropriate implementation of <see cref="IDeliveryStatusInfo"/> based on the concrete type
    ...
    /// </exception>
    private static IDeliveryStatusInfo MapToDeliverableEntityExt(IDeliverableEntity deliverableEntity)
    {
    ...
    /// </returns>
    private static IImmutableList<IDeliveryStatusInfo> MapToDeliverableEntitiesExt(this IImmutableList<IDeliverableEntity> entities)
    {
