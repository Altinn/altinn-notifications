...
public static class DeliverableEntitiesMapper
{
    ...
    /// <returns>
    /// An appropriate implementation of <see cref="IDeliverableEntityExt"/> based on the concrete type
    ...
    /// </exception>
    private static IDeliverableEntityExt MapToDeliverableEntityExt(IDeliverableEntity deliverableEntity)
    {
