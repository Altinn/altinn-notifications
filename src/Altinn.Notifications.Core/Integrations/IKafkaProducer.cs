...
public interface IKafkaProducer
{
    ...
    /// </summary>
    /// <param name="topicName">The name of the Kafka topic to publish the message to.</param>
    ...
    /// </summary>
    /// <param name="topicName">The name of the Kafka topic to publish the messages to.</param>
