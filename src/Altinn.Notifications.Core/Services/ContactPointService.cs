    ...
    IAuthorizationService authorizationService) : IContactPointService
{
    ...
    /// </param>
    /// <param name="orderPhase">
    /// The phase of the notification order. When set to <see cref="OrderPhase.Processing"/>, 
    /// user-registered contact points are authorized before being included. 
    /// For other phases, authorization is skipped and user-registered contact points are excluded.
    /// </param>
    /// <returns>
    ...
    private async Task AugmentRecipients(
        ...
        OrderPhase orderPhase = OrderPhase.Processing)
    {
        ...
        var organizationLookupTask = LookupOrganizationContactPoints(recipients, resourceId, orderPhase);
    ...
    /// </returns>
    private async Task<List<OrganizationContactPoints>> LookupOrganizationContactPoints(List<Recipient> recipients, string? resourceId, OrderPhase orderPhase = OrderPhase.Processing)
    {
