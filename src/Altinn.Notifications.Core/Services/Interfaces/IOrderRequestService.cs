...
public interface IOrderRequestService
{
    ...
    /// </exception>
    Task<Result<NotificationOrderChainResponse>> RegisterNotificationOrderChain(NotificationOrderChainRequest orderRequest, CancellationToken cancellationToken = default);
