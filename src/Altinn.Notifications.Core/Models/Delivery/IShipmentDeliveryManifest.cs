...
/// <remarks>
/// <para>
/// The <see cref="IShipmentDeliveryManifest"/> interface serves as the primary tracking contract in the notification system's
/// hierarchy. By extending <see cref="IStatus"/>, it enables standardized status monitoring at the shipment level
...
public interface IShipmentDeliveryManifest : IStatus
{
    ...
    /// </summary>
    /// <value>
    /// An immutable list of <see cref="IDeliveryManifest"/> instances, each representing
