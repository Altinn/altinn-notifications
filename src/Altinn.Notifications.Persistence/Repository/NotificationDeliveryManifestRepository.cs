...
public partial class NotificationDeliveryManifestRepository : INotificationDeliveryManifestRepository
{
    ...
    /// </summary>
    private static readonly Dictionary<string, ProcessingLifecycle> _smsStatusMap = new Dictionary<string, ProcessingLifecycle>(StringComparer.OrdinalIgnoreCase)
    {
    ...
    /// </summary>
    private static readonly Dictionary<string, ProcessingLifecycle> _emailStatusMap = new Dictionary<string, ProcessingLifecycle>(StringComparer.OrdinalIgnoreCase)
    {
    ...
    /// </summary>
    private static readonly Dictionary<string, ProcessingLifecycle> _orderStatusMap = new Dictionary<string, ProcessingLifecycle>(StringComparer.OrdinalIgnoreCase)
    {
