...
public class InstantOrderRepository : IInstantOrderRepository
{
    ...
    /// <summary>
    /// Persists the SMS texts for a notification order.
    /// </summary>
    ...
    /// <summary>
    /// Persists a notification order to the database and returns the its identifier.
    /// </summary>
    /// <param name="order">
    /// The <see cref="NotificationOrder"/> to be persisted.
    /// </param>
    /// <param name="connection">
    /// The active <see cref="NpgsqlConnection"/> to the PostgreSQL database.
    /// </param>
