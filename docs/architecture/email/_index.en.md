...
- [SendEmailQueueConsumer](https://github.com/Altinn/altinn-notifications/blob/main/components/email-service/src/Altinn.Notifications.Email.Integrations/Consumers/SendEmailQueueConsumer.cs):
  Consumes email objects with recipient data that are ready to be sent
- [EmailSendingAcceptedConsumer](https://github.com/Altinn/altinn-notifications/blob/main/components/email-service/src/Altinn.Notifications.Email.Integrations/Consumers/EmailSendingAcceptedConsumer.cs):
...
[the README in the repository](https://github.com/Altinn/altinn-notifications/tree/main/components/email-service). 
