...
public class EmailNotificationsControllerTests : IClassFixture<IntegrationTestWebApplicationFactory<Program>>
{
    ...
    public EmailNotificationsControllerTests(IntegrationTestWebApplicationFactory<Program> factory)
    {
