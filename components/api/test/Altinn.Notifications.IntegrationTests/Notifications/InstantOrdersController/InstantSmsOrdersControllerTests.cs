...
/// </summary>
public class InstantSmsOrdersControllerTests : IClassFixture<IntegrationTestWebApplicationFactory<Program>>
{
    ...
    /// </summary>
    public InstantSmsOrdersControllerTests(IntegrationTestWebApplicationFactory<Program> factory)
    {
        _factory = factory;
