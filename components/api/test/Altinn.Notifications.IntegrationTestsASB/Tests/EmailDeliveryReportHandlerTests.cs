...
public class EmailDeliveryReportHandlerTests(IntegrationTestContainersFixture fixture)
{
    ...
    /// the handler retries according to the configured policy and eventually moves the message
    /// to the native ASB dead letter queue.
    ...
    /// </summary>
    [Fact]
    public async Task EmailDeliveryReport_WhenNotificationNotFound_RetriesAndMovesToDeadLetterQueue()
    {
