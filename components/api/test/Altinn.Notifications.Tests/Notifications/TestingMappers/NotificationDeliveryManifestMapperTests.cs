...
public class NotificationDeliveryManifestMapperTests
{
    ...
    [InlineData(ProcessingLifecycle.SMS_Failed_TTL, ProcessingLifecycleExt.SMS_Failed_TTL)]
    ...
    [InlineData(ProcessingLifecycle.Email_Failed_TTL, ProcessingLifecycleExt.Email_Failed_TTL)]
    ...
    [InlineData(ProcessingLifecycle.Email_Failed_InvalidSasUrl, ProcessingLifecycleExt.Email_Failed_InvalidSasUrl)]
    ...
    [InlineData(ProcessingLifecycle.Email_Failed_PayloadTooLarge, ProcessingLifecycleExt.Email_Failed_PayloadTooLarge)]
