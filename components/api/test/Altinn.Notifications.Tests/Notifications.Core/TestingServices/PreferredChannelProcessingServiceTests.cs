...
namespace Altinn.Notifications.Tests.Notifications.Core.TestingServices
{
    public class PreferredChannelProcessingServiceTests
    {
        ...
        public async Task ProcessOrderRetry_EmailPreferred_CallsRetryMethods()
        {
            ...
            _contactPointMock
                .Setup(cp => cp.AddPreferredContactPoints(order.NotificationChannel, It.IsAny<List<Recipient>>(), It.IsAny<string?>(), It.IsAny<OrderLifecycleStage>(), It.IsAny<Creator>(), It.IsAny<string?>()))
        ...
        public async Task ProcessOrder_EmailPreferred_ReservedRecipientNoContacts_GoesToPreferredChannel()
        {
            ...
            _contactPointMock
                .Setup(cp => cp.AddPreferredContactPoints(It.IsAny<NotificationChannel>(), It.IsAny<List<Recipient>>(), It.IsAny<string?>(), It.IsAny<OrderLifecycleStage>(), It.IsAny<Creator>(), It.IsAny<string?>()))
                .Callback<NotificationChannel, List<Recipient>, string?, OrderLifecycleStage, Creator, string?>((_, recipients, _, _, _, _) =>
                {
