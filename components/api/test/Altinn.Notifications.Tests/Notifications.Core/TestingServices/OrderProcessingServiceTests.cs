...
public class OrderProcessingServiceTests
{
    ...
    public async Task ProcessOrder_SmsOrderWithoutCondition_ProcessedSuccessfully()
    {
        ...
        orderRepositoryMock.Verify(e => e.InsertStatusFeedAndNotificationLogForOrder(It.IsAny<Guid>()), Times.Never);
    ...
    public async Task ProcessOrder_SmsOrderWithUnmetSendingCondition_ProcessingStopped()
    {
        ...
        orderRepositoryMock.Verify(e => e.InsertStatusFeedAndNotificationLogForOrder(It.IsAny<Guid>()), Times.Once);
    ...
    public async Task ProcessOrder_EmailOrderWithUnmetSendingCondition_InsertStatusFeedThrowsException_ProcessingContinues()
    {
        ...
        var orderRepositoryMock = new Mock<IOrderRepository>();
        orderRepositoryMock.Setup(e => e.InsertStatusFeedAndNotificationLogForOrder(It.IsAny<Guid>())).ThrowsAsync(new Exception("Database error"));
    ...
    public async Task ProcessOrder_EmailOrderWithUnmetSendingCondition_InsertStatusFeedThrowsInvalidOperationException_ProcessingContinues()
    {
        ...
        var orderRepositoryMock = new Mock<IOrderRepository>();
        orderRepositoryMock.Setup(e => e.InsertStatusFeedAndNotificationLogForOrder(It.IsAny<Guid>())).ThrowsAsync(new InvalidOperationException("Order not found"));
