    ...
    public class ContactPointServiceTests
    {
        ...
        public async Task AddEmailContactPoints_WhenProfileClientThrowsTransientException_ShouldThrowPlatformDependencyException()
        {
            ...
            var exception = await Assert.ThrowsAsync<PlatformDependencyException>(
                async () => await service.AddEmailContactPoints(recipientsToEnrich, null, OrderLifecycleStage.Registration, new Creator("ttd")));
        ...
        public async Task AddSmsContactPoints_WhenUsingNationalId_ShouldEnrichRecipientsWithMobileNumber()
        {
            ...
            // Act
            await service.AddSmsContactPoints(recipientsToEnrich, null, OrderLifecycleStage.Registration, new Creator("ttd"));
        ...
        public async Task AddEmailContactPoints_WhenUsingNationalId_ShouldEnrichRecipientsWithEmailAddress()
        {
            ...
            // Act
            await service.AddEmailContactPoints(recipientsToEnrich, null, OrderLifecycleStage.Registration, new Creator("ttd"));
        ...
        public async Task AddEmailContactPoints_WhenResourceIdContainsUrnPrefix_ShouldSanitizeAndUseSlug()
        {
            ...
            // Act
            await service.AddEmailContactPoints(recipients, rawResourceIdWithPrefixAndWhitespace, OrderLifecycleStage.Processing, new Creator("ttd"));
        ...
        public async Task AddEmailAndSmsContactPoints_WhenUsingNationalId_ShouldEnrichRecipientsWithMobileNumbersAndEmailAddresses()
        {
            ...
            // Act
            await service.AddEmailAndSmsContactPointsAsync(recipientsToEnrich, null, OrderLifecycleStage.Registration, new Creator("ttd"));
        ...
        public async Task AddPreferredContactPoints_WhenUsingNationalIdAndSmsPreferred_ShouldEnrichRecipientsWithMobileNumbersOnly()
        {
            ...
            // Act
            await service.AddPreferredContactPoints(NotificationChannel.SmsPreferred, recipientsToEnrich, null, OrderLifecycleStage.Registration, new Creator("ttd"));
        ...
        public async Task AddPreferredContactPoints_WhenUsingNationalIdAndEmailPreferred_ShouldEnrichRecipientsWithEmailAddressOnly()
        {
            ...
            // Act
            await service.AddPreferredContactPoints(NotificationChannel.EmailPreferred, recipientsToEnrich, null, OrderLifecycleStage.Registration, new Creator("ttd"));
        ...
        public async Task AddSmsContactPoints_WhenUsingOrganizationNumber_ShouldEnrichRecipientsWithMobileNumbers()
        {
            ...
            // Act
            await service.AddSmsContactPoints(recipientsToEnrich, resourceIdentifier, OrderLifecycleStage.Processing, new Creator("ttd"));
        ...
        public async Task AddEmailContactPoints_WhenUsingOrganizationNumber_ShouldEnrichRecipientsWithEmailAddresses()
        {
            ...
            // Act
            await service.AddEmailContactPoints(recipientsToEnrich, resourceIdentifier, OrderLifecycleStage.Processing, new Creator("ttd"));
        ...
        public async Task AddSmsContactPoints_WhenUsingExternalIdentityProfileClientThrowsException_ShouldThrowPlatformDependencyException()
        {
            ...
            // Act & Assert
            var exception = await Assert.ThrowsAsync<PlatformDependencyException>(
                async () => await service.AddSmsContactPoints(recipientsToEnrich, null, OrderLifecycleStage.Registration, new Creator("ttd")));
