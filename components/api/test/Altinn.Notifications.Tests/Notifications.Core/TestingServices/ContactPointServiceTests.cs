...
namespace Altinn.Notifications.Tests.Notifications.Core.TestingServices
{
    public class ContactPointServiceTests
    {
        ...
        public async Task AddEmailContactPoints_WhenProfileClientThrowsTransientException_ShouldThrowPlatformDependencyException()
        {
            ...
            profileClientMock
                .Setup(e => e.GetUserContactPoints(It.Is<List<string>>(e => e.Contains(nationalId)), It.Is<bool>(b => b == false)))
            ...
            var exception = await Assert.ThrowsAsync<PlatformDependencyException>(
                async () => await service.AddEmailContactPoints(recipientsToEnrich, null, OrderLifecycleStage.Registration, false));
            ...
            profileClientMock.Verify(
                e => e.GetUserContactPoints(It.Is<List<string>>(e => e.Contains(nationalId)), It.Is<bool>(b => b == false)),
                Times.Once);
        ...
        public async Task AddSmsContactPoints_WhenUsingNationalId_ShouldEnrichRecipientsWithMobileNumber()
        {
            ...
            // Act
            await service.AddSmsContactPoints(recipientsToEnrich, null, OrderLifecycleStage.Registration, false);
            ...
            profileClientMock.Verify(e => e.GetUserContactPoints(It.Is<List<string>>(e => e.Contains(nationalId)), It.Is<bool>(b => b == false)), Times.Once);
        ...
        public async Task AddEmailContactPoints_WhenUsingNationalId_ShouldEnrichRecipientsWithEmailAddress()
        {
            ...
            // Act
            await service.AddEmailContactPoints(recipientsToEnrich, null, OrderLifecycleStage.Registration, false);
        ...
        public async Task AddEmailContactPoints_WhenResourceIdContainsUrnPrefix_ShouldSanitizeAndUseSlug()
        {
            ...
            // Act
            await service.AddEmailContactPoints(recipients, rawResourceIdWithPrefixAndWhitespace, OrderLifecycleStage.Processing, false);
        ...
        public async Task AddEmailAndSmsContactPoints_WhenUsingNationalId_ShouldEnrichRecipientsWithMobileNumbersAndEmailAddresses()
        {
            ...
            // Act
            await service.AddEmailAndSmsContactPointsAsync(recipientsToEnrich, null, OrderLifecycleStage.Registration, false);
        ...
        public async Task AddPreferredContactPoints_WhenUsingNationalIdAndSmsPreferred_ShouldEnrichRecipientsWithMobileNumbersOnly()
        {
            ...
            // Act
            await service.AddPreferredContactPoints(NotificationChannel.SmsPreferred, recipientsToEnrich, null, OrderLifecycleStage.Registration, false);
        ...
        public async Task AddPreferredContactPoints_WhenUsingNationalIdAndEmailPreferred_ShouldEnrichRecipientsWithEmailAddressOnly()
        {
            ...
            // Act
            await service.AddPreferredContactPoints(NotificationChannel.EmailPreferred, recipientsToEnrich, null, OrderLifecycleStage.Registration, false);
        ...
        public async Task AddSmsContactPoints_WhenUsingOrganizationNumber_ShouldEnrichRecipientsWithMobileNumbers()
        {
            ...
            // Act
            await service.AddSmsContactPoints(recipientsToEnrich, resourceIdentifier, OrderLifecycleStage.Processing, false);
        ...
        public async Task AddEmailContactPoints_WhenUsingOrganizationNumber_ShouldEnrichRecipientsWithEmailAddresses()
        {
            ...
            // Act
            await service.AddEmailContactPoints(recipientsToEnrich, resourceIdentifier, OrderLifecycleStage.Processing, false);
        ...
        [Fact]
        public async Task AddEmailContactPoints_WhenUsingExternalIdentity_ShouldEnrichRecipientsWithEmailAddress()
        {
            // Arrange
            string emailAddress = "recipient@example.com";
            ...
            profileClientMock.Verify(e => e.GetUserContactPoints(It.IsAny<List<string>>(), It.IsAny<bool>()), Times.Never);
        ...
        [Fact]
        public async Task AddPreferredContactPoints_WhenUsingExternalIdentityAndEmailPreferred_ShouldSelectEmailWhenAvailable()
        {
            // Arrange
            string rawMobileNumber = "99999999";
            string emailAddress = "recipient@example.com";
        ...
        [Fact]
        public async Task AddSmsContactPoints_WhenUsingExternalIdentity_ShouldEnrichRecipientsWithMobileNumber()
        {
            // Arrange
            string rawMobileNumber = "99999999";
            string formattedMobileNumber = "+4799999999";
        ...
        [Fact]
        public async Task AddSmsContactPoints_WhenUsingExternalIdentityWithInvalidMobileNumber_ShouldNotAddContactPoint()
        {
            // Arrange
        ...
        public async Task AddSmsContactPoints_WhenUsingExternalIdentityProfileClientThrowsException_ShouldThrowPlatformDependencyException()
        {
            ...
            // Act & Assert
            var exception = await Assert.ThrowsAsync<PlatformDependencyException>(
                async () => await service.AddSmsContactPoints(recipientsToEnrich, null, OrderLifecycleStage.Registration, false));
        ...
        [Fact]
        public async Task AddEmailAndSmsContactPoints_WhenUsingExternalIdentity_ShouldEnrichRecipientsWithBothContactPoints()
        {
            // Arrange
            string rawMobileNumber = "99999999";
            string formattedMobileNumber = "+4799999999";
        ...
        [Fact]
        public async Task AddPreferredContactPoints_WhenUsingExternalIdentityAndSmsPreferred_ShouldSelectSmsWhenAvailable()
        {
            // Arrange
            string rawMobileNumber = "99999999";
            string formattedMobileNumber = "+4799999999";
        ...
        [Fact]
        public async Task AddPreferredContactPoints_WhenUsingExternalIdentityAndEmailPreferredButNoEmail_ShouldFallbackToSms()
        {
            // Arrange
            string rawMobileNumber = "99999999";
            string formattedMobileNumber = "+4799999999";
        ...
        [Fact]
        public async Task AddPreferredContactPoints_WhenUsingExternalIdentityAndSmsPreferredButNoSms_ShouldFallbackToEmail()
        {
            // Arrange
            string emailAddress = "recipient@example.com";
            string externalIdentity = "urn:altinn:person:idporten-email:recipient@example.com";
