...
public class SmsSendResultProducerTests
{
    ...
    public async Task DispatchAsync_ProducesExactlyOnce()
    {
        ...
        var sut = new SmsSendResultProducer(producerMock.Object, new TopicSettings { SmsStatusUpdatedTopicName = _topicName });
    ...
    {
        var sut = new SmsSendResultProducer(new Mock<ICommonProducer>().Object, new TopicSettings { SmsStatusUpdatedTopicName = _topicName });
